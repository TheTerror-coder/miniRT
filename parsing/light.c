...
/*   Updated: 2023/08/20 18:06:29 by TheTerror        ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
...
t_bool	ft_set_lcolor(t_vars *v, char *infocolor)
{
	...
	v->l->r = ft_atoi(colors[0]);
	v->l->g = ft_atoi(colors[1]);
	v->l->b = ft_atoi(colors[2]);
	ft_free2str(&colors);
	if (v->l->r < 0 || v->l->r > 255 || v->l->g < 0 || v->l->g > 255 || \
		v->l->b < 0 || v->l->b > 255)
